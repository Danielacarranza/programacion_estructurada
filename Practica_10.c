...
printf("\n\nID %5s %5s %5s %5s %5s %5s %5s %5s %5s\n","NOMBRE","APELLIDO","SEGUNDO APELLIDO","CUMPLEAÑOS","ESCUELA","SEMESTRE","ESCUELA","CARRERA","GENERO");
for (i=0; i<num_alumnos; i++){
	printf("%d %5s %5s %5s %5s %5s %5d %5s %5s\n",alu[i].id ,alu[i].first_name ,alu[i].last_name ,alu[i].sec_last_name,alu[i].bday,alu[i].escuela,alu[i].semestre,alu[i].carrera,alu[i].genero);
}
